...
by a variety of other sites. We encourage the community to
...
1. Navigate your web browser to [the Issues tab of the Project Pythia portal repository](https://github.com/ProjectPythia/projectpythia.github.io/issues).
1. Click on the button that says “New issue”.
1. Click on the row labeled “Update resource gallery”, and follow the instructions presented.

Your request will be reviewed, and you
...
Like with contributing to Foundations, you will want to be familiar with conda and Git.
