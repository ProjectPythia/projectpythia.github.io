...
```{dropdown} A hands on approach to climate physics and climate modeling. This JupyterBook serves as a course tex ... <br> **See Full Description:**
A hands on approach to climate physics and climate modeling. This JupyterBook serves as a course textbook at the University of Albany. It is self-reproducing, free and open, interactive, and is a living document.

```

```{link-button} https://brian-rose.github.io/ClimateLaboratoryBook/home
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Earth analytics is an intermediate, multidisciplinary course that addresses major questions in Earth ... <br> **See Full Description:**
...
```{link-button} https://www.earthdatascience.org/courses/earth-analytics-python/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} This site contains open, tutorials and course materials covering topics including data integration,  ... <br> **See Full Description:**
...
```{link-button} https://www.earthdatascience.org/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Geohackweek is a 5-day hackweek to be held at the University of Washington eScience Institute. Tutor ... <br> **See Full Description:**
...
```{link-button} https://geohackweek.github.io/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: Damien Irving, et al.
...
```{dropdown} We believe every researcher should know how to write short programs that clean and analyze data in a ... <br> **See Full Description:**
...
```{link-button} https://merely-useful.github.io/py-rse/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} "Data Analysis with Python: Zero to Pandas" is a practical and beginner-friendly introduction to dat ... <br> **See Full Description:**
...
```{link-button} https://jovian.ai/learn/data-analysis-with-python-zero-to-pandas
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} In this course, we will have multiple occasions to procure, analyze, and visualize data. We will stu ... <br> **See Full Description:**
...
```{link-button} http://web.pdx.edu/~gjay/teaching/mth271_2020/html/_CONTENTS.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} This course teaches radiation and remote sensing, but also covers: how to write clear, documented an ... <br> **See Full Description:**
...
```{link-button} https://clouds.eos.ubc.ca/~phil/courses/atsc301/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} The goal of this lesson is to provide an introduction to core geospatial data concepts. It is intend ... <br> **See Full Description:**
...
```{link-button} https://datacarpentry.org/organization-geospatial/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: Dani Arribas-Bel



Affiliation: University of Liverpool Department of Geography and Planning

University of Liverpool Department of Geography and Planning Site: https://www.liverpool.ac.uk/geography-and-planning/

```{dropdown} A collection of courework repositories for various data science classes taught by Dani Arribas-Bel.
 ... <br> **See Full Description:**
A collection of courework repositories for various data science classes taught by Dani Arribas-Bel.

```

```{link-button} http://darribas.org/materials.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Cartopy is a Python package designed for geospatial data processing in order to produce maps and oth ... <br> **See Full Description:**
Cartopy is a Python package designed for geospatial data processing in order to produce maps and other geospatial data analyses.

```

```{link-button} https://scitools.org.uk/cartopy/docs/latest/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Visual examples demonstrating some of the functionality of Cartopy, particularly its matplotlib inte ... <br> **See Full Description:**
Visual examples demonstrating some of the functionality of Cartopy, particularly its matplotlib interface.

```

```{link-button} https://scitools.org.uk/cartopy/docs/latest/gallery/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} contextily is a small Python 3 (3.6 and above) package to retrieve tile maps from the internet. It c ... <br> **See Full Description:**
...
```{link-button} https://contextily.readthedocs.io
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Welcome to the taster guide for contextily, the package for contextual tiles in Python. In this note ... <br> **See Full Description:**
...
```{link-button} https://contextily.readthedocs.io/en/latest/intro_guide.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: Dask core developers
...
```{dropdown} Dask provides advanced parallelism for analytics, enabling performance at scale for the tools you lo ... <br> **See Full Description:**
Dask provides advanced parallelism for analytics, enabling performance at scale for the tools you love.

```

```{link-button} https://dask.org
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Dask is a parallel computing library that scales the existing Python ecosystem. This tutorial will i ... <br> **See Full Description:**
...
```{link-button} https://tutorial.dask.org/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} The examples below show GeoCAT-comp functions being utilized in real-world use cases. They also demo ... <br> **See Full Description:**
...
```{link-button} https://geocat-comp.readthedocs.io/en/latest/examples.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} A gallery of plotting examples from GeoCat.
 ... <br> **See Full Description:**
A gallery of plotting examples from GeoCat.

```

```{link-button} https://geocat-examples.readthedocs.io/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: GeoPandas developers
...
```{dropdown} GeoPandas is an open source project to make working with geospatial data in python easier. GeoPandas ... <br> **See Full Description:**
GeoPandas is an open source project to make working with geospatial data in python easier. GeoPandas extends the datatypes used by pandas to allow spatial operations on geometric types. Geometric operations are performed by shapely. Geopandas further depends on fiona for file access and matplotlib for plotting.

```

```{link-button} https://geopandas.org
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Examples that show off the functionality in GeoPandas. They highlight many of the things you can do  ... <br> **See Full Description:**
...
```{link-button} https://geopandas.org/gallery/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} hvPlot provides a high-level plotting API built on HoloViews that provides a general and consistent  ... <br> **See Full Description:**
...
```{link-button} https://hvplot.holoviz.org/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} The user guide provides a detailed introduction to the API and features of hvPlot. In the Introducti ... <br> **See Full Description:**
...
```{link-button} https://hvplot.holoviz.org/user_guide/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Incomplete Reference Gallery containing some small examples of different plot types using hvPlot.
 ... <br> **See Full Description:**
Incomplete Reference Gallery containing some small examples of different plot types using hvPlot.

```

```{link-button} https://hvplot.holoviz.org/reference/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: The Jupyter development team
...
```{dropdown} Interactive maps in the Jupyter notebook.
 ... <br> **See Full Description:**
Interactive maps in the Jupyter notebook.

```

```{link-button} https://ipyleaflet.readthedocs.io
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: the Matplotlib development team
...
```{dropdown} Matplotlib is a comprehensive library for creating static, animated, and interactive visualizations  ... <br> **See Full Description:**
Matplotlib is a comprehensive library for creating static, animated, and interactive visualizations in Python.

```

```{link-button} https://matplotlib.org/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} This page contains more in-depth guides for using Matplotlib. It is broken up into beginner, interme ... <br> **See Full Description:**
...
```{link-button} https://matplotlib.org/stable/tutorials/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} This gallery contains examples of the many things you can do with Matplotlib.
 ... <br> **See Full Description:**
This gallery contains examples of the many things you can do with Matplotlib.

```

```{link-button} https://matplotlib.org/stable/gallery/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} MetPy is a collection of tools in Python for reading, visualizing, and performing calculations with  ... <br> **See Full Description:**
MetPy is a collection of tools in Python for reading, visualizing, and performing calculations with weather data.

```

```{link-button} https://unidata.github.io/MetPy/latest/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} This collection of tutorials (under development) demonstrates the use of MetPy to perform common met ... <br> **See Full Description:**
This collection of tutorials (under development) demonstrates the use of MetPy to perform common meteorological tasks.

```

```{link-button} https://unidata.github.io/MetPy/latest/tutorials/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} MetPy is a modern meteorological open-source toolkit for Python. It is a maintained project of Unida ... <br> **See Full Description:**
...
```{link-button} https://unidata.github.io/python-training/workshop/Metpy_Introduction/introduction-to-metpy/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Examples of using a variety of MetPy’s functionality together.
 ... <br> **See Full Description:**
Examples of using a variety of MetPy’s functionality together.

```

```{link-button} https://unidata.github.io/MetPy/latest/examples/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Check out detailed examples for atmospheric science and meteorology, from data analysis to publicati ... <br> **See Full Description:**
Check out detailed examples for atmospheric science and meteorology, from data analysis to publication-quality figures.

```

```{link-button} https://unidata.github.io/python-training/gallery/gallery-home/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} A weekly video series showing how to use MetPy or other Python libraries to solve problems relevant  ... <br> **See Full Description:**
...
```{link-button} https://www.youtube.com/playlist?list=PLQut5OXpV-0ir4IdllSt1iEZKTwFBa7kO
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} The fundamental package for scientific computing with Python.
 ... <br> **See Full Description:**
The fundamental package for scientific computing with Python.

```

```{link-button} https://numpy.org
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} A curated collection of external resources teaching numpy from beginner to advanced uses.
 ... <br> **See Full Description:**
A curated collection of external resources teaching numpy from beginner to advanced uses.

```

```{link-button} https://numpy.org/learn/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Unidata Numpy tutorial that covers how to create an array of ‘data’, perform basic calculations on t ... <br> **See Full Description:**
...
```{link-button} https://unidata.github.io/python-training/workshop/NumPy/numpy-basics/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: A. Chabot-LeClerc



Affiliation: Enthought

Enthought Site: https://www.enthought.com/

```{dropdown} NumPy provides Python with a powerful array processing library and an elegant syntax that is well su ... <br> **See Full Description:**
...
```{link-button} https://youtu.be/ZB7BZMhfPgk
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: Pandas Development Team
...
```{dropdown} Pandas is a fast, powerful, flexible and easy to use open source data analysis and manipulation tool ... <br> **See Full Description:**
Pandas is a fast, powerful, flexible and easy to use open source data analysis and manipulation tool, built on top of the Python programming language.

```

```{link-button} https://pandas.pydata.org/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Tutorial for getting started with pandas.
 ... <br> **See Full Description:**
Tutorial for getting started with pandas.

```

```{link-button} https://pandas.pydata.org/docs/getting_started/intro_tutorials/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} A gallery of example pandas functionality.
 ... <br> **See Full Description:**
A gallery of example pandas functionality.

```

```{link-button} https://pandas.pydata.org/pandas-docs/stable/user_guide/visualization.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Geographic information systems use GeoTIFF and other formats to organize and store gridded raster da ... <br> **See Full Description:**
Geographic information systems use GeoTIFF and other formats to organize and store gridded raster datasets such as satellite imagery and terrain models. Rasterio reads and writes these formats and provides a Python API based on Numpy N-dimensional arrays and GeoJSON.

```

```{link-button} https://rasterio.readthedocs.io
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} This document explains how to use Rasterio to read existing files and to create new files. Some adva ... <br> **See Full Description:**
...
```{link-button} https://rasterio.readthedocs.io/en/latest/quickstart.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
Created by: Siphon Contributors
...
```{dropdown} Siphon is a collection of Python utilities for downloading data from remote data services. Much of S ... <br> **See Full Description:**
...
```{link-button} https://unidata.github.io/siphon
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} An overview on Siphon from the Unidata Python Workshop that: uses Siphon to access a THREDDS catalog ... <br> **See Full Description:**
...
```{link-button} https://unidata.github.io/python-training/workshop/Siphon/siphon-overview/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Examples of using Siphon’s functionality.
 ... <br> **See Full Description:**
Examples of using Siphon’s functionality.

```

```{link-button} https://unidata.github.io/siphon/latest/examples/index.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} A collection of diagnostic and interpolation routines for use with output from the Weather Research  ... <br> **See Full Description:**
A collection of diagnostic and interpolation routines for use with output from the Weather Research and Forecasting (WRF-ARW) Model.

```

```{link-button} https://wrf-python.readthedocs.io
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} Examples of how wrf-python can be used to make plots with matplotlib (with basemap and cartopy) and  ... <br> **See Full Description:**
...
```{link-button} https://wrf-python.readthedocs.io/en/latest/plot.html
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} xarray (formerly xray) is an open source project and Python package that makes working with labelled ... <br> **See Full Description:**
...
```{link-button} http://xarray.pydata.org/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} An introduction to Xarray through the Unidata Python Workshop that asks, "What is XArray and how doe ... <br> **See Full Description:**
...
```{link-button} https://unidata.github.io/python-training/workshop/XArray/xarray-introduction/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
...
```{dropdown} A collection of tutorials provided by the Xarray developers.
 ... <br> **See Full Description:**
A collection of tutorials provided by the Xarray developers.

```

```{link-button} https://xarray-contrib.github.io/xarray-tutorial/
:type: url
:text: Visit Website
:classes: btn-outline-primary btn-block
```
